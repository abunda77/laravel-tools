        ...
        $this->sections = [
            ...
            [
                ...
                'items' => [
                    ...
                    ['label' => 'API Docs', 'route' => 'scramble.docs.ui', 'icon' => 'docs'],
...
@php
    $iconPaths = [
        ...
        'qrcode' => 'M3.75 4.5A1.75 1.75 0 0 1 5.5 2.75h3A1.75 1.75 0 0 1 10.25 4.5v3A1.75 1.75 0 0 1 8.5 9.25h-3A1.75 1.75 0 0 1 3.75 7.5v-3Zm9 0A1.75 1.75 0 0 1 14.5 2.75h3A1.75 1.75 0 0 1 19.25 4.5v3A1.75 1.75 0 0 1 17.5 9.25h-3A1.75 1.75 0 0 1 12.75 7.5v-3ZM3.75 13.5A1.75 1.75 0 0 1 5.5 11.75h3A1.75 1.75 0 0 1 10.25 13.5v3A1.75 1.75 0 0 1 8.5 18.25h-3A1.75 1.75 0 0 1 3.75 16.5v-3Zm12.25 7.75a.75.75 0 0 0 0-1.5h-1.5v-1.5a.75.75 0 0 0-1.5 0v2.25a.75.75 0 0 0 .75.75h2.25Zm4-4a.75.75 0 0 0 0-1.5h-3v-1.5a.75.75 0 0 0-1.5 0V21h4.5v-3.75Z',
    ];
